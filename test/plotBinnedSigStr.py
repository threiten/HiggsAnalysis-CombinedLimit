...
xlabels  = {
    ...
    'Jet2p5AbsRapidity0': r'\left|y^{j_{0}}\right|',
    'Jet2p5Pt0': (r'p_{T}^{j_{0}}', r'GeV'),
    'TauCJets4p7': (r'\tau_{C,j}', r'GeV'),
    'AbsDeltaRapidityGgJet2p50': r'\left|\Delta Y_{\gamma\gamma,j_{0}}\right|',
    'AbsDeltaPhiGgJet2p50': r'\left|\Delta\phi_{\gamma\gamma,j_{0}}\right|',
    'Jet4p7Pt1': r'p_{T}^{j_{1}} \textnormal{(GeV)}',
    'Jet4p7AbsRapidity1': r'\left|y^{j_{1}}\right|',
    'AbsDeltaPhiGgJjJets4p7': r'\left|\Delta\phi_{\gamma\gamma,j_{0}j_{1}}\right|',
    'AbsDeltaPhiJ1J2Jets4p7': r'\left|\Delta\phi_{j_{0},j_{1}}\right|',
    'AbsZeppenfeldEtaJets4p7': r'\left|\eta_{\gamma\gamma}-\bar{\eta}_{j_{0},j_{1}}\right|',
    'MjjJets4p7': r'm_{jj} \textnormal{(GeV)}',
    'AbsDeltaEtaJ1J2Jets4p7': r'\left|\Delta\eta_{j_{0},j_{1}}\right|',
    'Nleptons': r'\boldsymbol{n_{leptons}}',
    'NBjets2p5': r'\boldsymbol{n_{Bjets}}',
    'PtMiss': r'p_{T}^{miss} \textnormal{(GeV)}',
    'AbsPhiS': r'\left|\phi_{\gamma\gamma}^{\ast}\right|',
}

cutStr = {
    'Pt': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'Njets2p5': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{jet}\right|<2.5$\\$p_{T}^{jet}>30\,\textnormal{GeV}$\end{flushleft}',
    'CosThetaS': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'AbsRapidity': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'Jet2p5AbsRapidity0': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<2.5$\\$p_{T}^{j_{0}}>30\,\textnormal{GeV}$\end{flushleft}',
    'Jet2p5Pt0': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<2.5$\\$p_{T}^{j_{0}}>30\,\textnormal{GeV}$\end{flushleft}',
    'TauCJets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<4.7$\end{flushleft}',
    'AbsDeltaRapidityGgJet2p50': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<2.5$\\$p_{T}^{j_{0}}>30\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaPhiGgJet2p50': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<2.5$\\$p_{T}^{j_{0}}>30\,\textnormal{GeV}$\end{flushleft}',
    'Jet4p7Pt1': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{1}}\right|<4.7$\\$p_{T}^{j_{1}}>30\,\textnormal{GeV}$\end{flushleft}',
    'Jet4p7AbsRapidity1': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{1}}\right|<4.7$\\$p_{T}^{j_{1}}>30\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaPhiGgJjJets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaPhiJ1J2Jets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\end{flushleft}',
    'AbsZeppenfeldEtaJets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\end{flushleft}',
    'MjjJets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaEtaJ1J2Jets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\end{flushleft}',
    'Nleptons': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'NBjets2p5': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{jet}\right|<2.5$\\$p_{T}^{jet}>30\,\textnormal{GeV}$\end{flushleft}',
    'PtMiss': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'AbsPhiS': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\end{flushleft}',
    'PtVBFlike': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{1}}\right|<4.7$\\$p_{T}^{j_{1}}>30\,\textnormal{GeV}$\\$n_{jets}=2$\\$\Delta\eta_{j0,j1}>3.5$\\$m_{jj}>200\,\textnormal{GeV}$\end{flushleft}',
    'PtVBFlikeMergeB': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{1}}\right|<4.7$\\$p_{T}^{j_{1}}>30\,\textnormal{GeV}$\\$n_{jets}=2$\\$\Delta\eta_{j0,j1}>3.5$\\$m_{jj}>200\,\textnormal{GeV}$\end{flushleft}',
    'Jet4p7Pt1VBFlike': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{1}}\right|<4.7$\\$p_{T}^{j_{1}}>30\,\textnormal{GeV}$\\$n_{jets}=2$\\$\Delta\eta_{j0,j1}>3.5$\\$m_{jj}>200\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaPhiGgJjJets4p7VBFlike': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\\$n_{jets}=2$\\$\Delta\eta_{j0,j1}>3.5$\\$m_{jj}>200\,\textnormal{GeV}$\end{flushleft}',
    'AbsDeltaPhiJ1J2Jets4p7VBFlike': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{i}}\right|<4.7$\\$p_{T}^{j_{i}}>30\,\textnormal{GeV}$\\$n_{jets}=2$\\$\Delta\eta_{j0,j1}>3.5$\\$m_{jj}>200\,\textnormal{GeV}$\end{flushleft}',
    'PtTauCJet2p50': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<2.5$\\$p_{T}^{j_{0}}>30\,\textnormal{GeV}$\end{flushleft}',
    'PtTauCJets4p7': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<4.7$\end{flushleft}',
    'PtTauCJets4p7MergeB': r'\begin{flushleft}$\boldsymbol{H\rightarrow\gamma\gamma}$\\$\left|\eta^{j_{0}}\right|<4.7$\end{flushleft}',
}
...
ePredLDict = {
    'nominal' : r'\textsc{MadGraph}\xspace{}5\_a\textsc{mc@nlo}, NNLOPS',
...
def getBins(var, ext, mergeBins=None):
    ...
    if mergeBins is None:
        mergeBins = []
        mergeBEx = True
    cfg = yaml.load(open('/afs/cern.ch/work/t/threiten/Hgg/Differentials/CMSSW_10_2_13/src/flashggFinalFit/splitConfig_{}_2016.yaml'.format(ext)))
    topLvl = None
    topVar = None
    try:
...
def main(options):
    ...
    figHeight = 10 if 'VBFlike' in options.extension else 8
    fig, axes = plt.subplots(2, len(binns), figsize=(figWidth*8, figHeight), sharex='col', sharey='row', gridspec_kw={'height_ratios': [3, 1]}, squeeze=False)
    fig.tight_layout()
    ...
    for i in range(len(binns)):
        tops[i].errorbar(bcen[i], pred[i], xerr=xerrs[i], linestyle='none', markersize=0, capsize=0, elinewidth=1, label=predLabels['nominal'], color=predColors[0])
        for p, ePred in enumerate(extraPred):
            tops[i].errorbar(bcen[i], ePred[i], xerr=xerrs[i], linestyle='none', markersize=0, capsize=0, elinewidth=1, label=predLabels[ePredKeys[p]], color=predColors[p+1])
            if options.commonPredComp is not None:
                if ePredKeys[p] == commonPredKey:
                    cPredboxesTop = [matplotlib.patches.Rectangle((x0, y0), x1-x0, y1-y0, zorder=2) for x0, y0, x1, y1 in zip(bcen[i]-xerrs[i], 0, bcen[i]+xerrs[i], ePred[i])]
                    cpbTop = matplotlib.collections.PatchCollection(cPredboxesTop, edgecolor=predColors[p+1], facecolor='None', hatch='x', zorder=3)
                    topcpbColl = tops[i].add_collection(cpbTop)

        (_,caps,_) = tops[i].errorbar(bcen[i], obsed[i], yerr=obsedErrs[i], xerr=xerrs[i], marker='.', linestyle='none',markersize=4, capsize=3, linewidth=1, label=res_label, color='black')
        for cap in caps:
        ...
        (_,caps,_) = bottoms[i].errorbar(bcen[i], cval[i], yerr=errs[i], xerr=xerrs[i], marker='.', linestyle='none',markersize=4, capsize=3, linewidth=1, label=r'Expected Result, stat$\oplus$syst unc.', color='black')
        for p, ePred in enumerate(extraPred):
            if ePredKeys[p] in options.predToSkipRatio:
                continue
            (_,caps,_) = bottoms[i].errorbar(bcen[i], np.divide(ePred[i], pred[i]), xerr=xerrs[i], markersize=0, linestyle='none', capsize=0, elinewidth=1, label=predLabels[ePredKeys[p]], color=predColors[p+1])
        for cap in caps:
            cap.set_markeredgewidth(1)
        ...
        if cappedOverflow[i]:
            ...
            if isinstance(xlb, tuple):
                fig.text(bcen[i][-1]+0.5*xerrs[i][-1], 1.1*yPos, r'$\boldsymbol{{\sigma_{{fid}}\left({{{0}}}>{{{1}}}\,\textnormal{{{2}}}\right)/{{{3:.1f}}}\,\textnormal{{{2}}}}}$'.format(xlb[0], binns[i][-2], xlb[1], binns[i][-1] - binns[i][-2]), fontsize=10, transform=tops[i].transData, verticalalignment='bottom', rotation=90) #-xerrs[i][-1]
            else:
                fig.text(bcen[i][-1], yPos, r'$\boldsymbol{{\sigma_{{fid}}\left({{{0}}}>{{{1}}}\right)/{{{2:.1f}}}}}$'.format(xlb, binns[i][-2], binns[i][-1] - binns[i][-2]), fontsize=10, transform=tops[i].transData, horizontalalignment='center')
    ...
    bottoms[0].set_ylabel(r'Ratio to prediction',fontsize=11)
    if isinstance(xlb, tuple):
        tops[0].set_ylabel(r'$\Delta\sigma_{{fid}}/\Delta {{{0}}}$(\mbox{{\ensuremath{{\text{{fb/{{{1}}}}}}}}}\xspace)'.format(xlb[0], xlb[1]))
    else:
        tops[0].set_ylabel(r'$\Delta\sigma_{{fid}}/\Delta {{{0}}}$'.format(xlb) + r'(\mbox{\ensuremath{\text{fb}}}\xspace)') 
        # bottom.set_ylabel(r'$\sigma(H\rightarrow\gamma\gamma)/\sigma_{SM}(H\rightarrow\gamma\gamma)$',fontsize=14)
    ...
    if options.showTheoryUnc:
        ...
        for theoryErr in ePredKeysHere+['nominal']:
            ...
            legLine = mlines.Line2D([], [], color=topErrCollTheoryUnc[theoryErr].get_edgecolor()[0], marker='None', zorder=3, linewidth=1)
            topLegHandles[topLegLabels.index(predLabels[theoryErr])] = (legPatch, legLine)
    tops[-1].legend(labels=topLegLabels, handles=topLegHandles, fontsize=14, framealpha=0)

    # if options.log:
    #     plt.text(5,2, r'$\boldsymbol{H\rightarrow\gamma\gamma}$', fontsize=16)
    #     plt.text(2,2.53, r'\textbf{CMS} \textit{Work in Progress}', fontsize=15)
    #     plt.text(400,2.53, r'$136.1~\textnormal{fb}^{-1}$ ($13~\textnormal{TeV}$)', fontsize=15)
    # else:
    try:
    ...
    fig.canvas.draw()
    legPos = tops[-1].get_legend().get_window_extent()
    figsize = fig.get_size_inches()*fig.dpi
    cutText = tops[0].text(0.02, 0.97, cutString, fontsize=16, verticalalignment='top', transform=tops[0].transAxes)
    textPos = cutText.get_window_extent()
    axPosZero = tops[0].get_position()
    if options.showPvalue:
        pvaltxt = fig.text(legPos.x0/figsize[0], min(textPos.y0/figsize[1]-0.01, legPos.y0/figsize[1]-0.01), r'p-value(SM): $\boldsymbol{{{{{:.3f}}}}}$'.format(pvalSMCompat), fontsize=14, verticalalignment='top')
        pvaltxtPos = pvaltxt.get_window_extent()
    if topLvl is not None:
        tlb = xlabels[topVar]
    ...
    if options.showUnderflow and topLvl is None:
        ...
        if isinstance(xlb, tuple):
            fig.text(bcen[0][0]-xerrs[0][0], 1.1*yPos, r'$\boldsymbol{{\sigma_{{fid}}\left({{{0}}}<{{{1}}}\,\textnormal{{{2}}}\right)/{{{3}}}\,\textnormal{{{2}}}}}$'.format(xlb[0], binns[0][1], xlb[1], binns[0][1] - binns[0][0]), fontsize=10, transform=tops[0].transData) #, horizontalalignment='center')
        else:
            fig.text(bcen[0][0]-xerrs[0][0], 1.1*yPos, r'$\boldsymbol{{\sigma_{{fid}}\left({{{0}}}<{{{1}}}\right)/{{{2}}}}}$'.format(xlb, binns[0][1], binns[0][1] - binns[0][0]), fontsize=10, transform=tops[0].transData) #, horizontalalignment='center')
    if options.wip:
        fig.text(0.08/figWidth, 0.97, r'\textbf{CMS} \textit{Work in Progress}', fontsize=22)
    elif options.prelim:
        fig.text(0.08/figWidth, 0.97, r'\textbf{CMS} \textit{Preliminary}', fontsize=22)
    else:
        fig.text(0.08/figWidth, 0.97, r'\textbf{CMS}', fontsize=22)
    fig.text(1-(0.33/(figWidth)), 0.97, r'138\mbox{\ensuremath{\,\text{fb}^{-1}}}\xspace (13\ensuremath{\,\text{Te\hspace{-.08em}V}}\xspace)', fontsize=22)
