...
do
    hadd -f higgsCombineDataScan_${param}.MultiDimFit.mH125.38.root higgsCombineDataScan_${param}.POINTS.*.MultiDimFit.mH125.38.root
    hadd -f higgsCombineDataScanStat_${param}.MultiDimFit.mH125.38.root higgsCombineDataScanStat_${param}.POINTS.*.MultiDimFit.mH125.38.root
done

for param in ${paramStrNoOne//\,/\ }
do
    plot1DScan.py --POI ${param} -o ${param}ScanData --main-label="Observed stat+syst unc." higgsCombineDataScan_${param}.MultiDimFit.mH125.38.root --others higgsCombineAsimovPostFitScanFit_${param}.MultiDimFit.mH125.38.root:"Expected stat+syst unc.":2 higgsCombineDataScanStat_${param}.MultiDimFit.mH125.38.root:"Observed stat unc.":7
done
